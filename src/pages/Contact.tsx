	...
	const contactInfo = [
		{
			...
			label: 'Email',
			value: 'erickdevartworks@gmail.com',
			link: 'mailto:erickdevartworks@gmail.com'
		},
		{
			icon: <Phone className="w-5 h-5" />,
			label: 'Phone',
			value: '+37127727393',
			link: 'tel:+37127727393'
		},
		{
				...
				<div className="grid lg:grid-cols-[1fr,1.5fr] gap-8 sm:gap-12">
					...
					<div className="space-y-6 sm:space-y-8">
						...
						<motion.div
							...
							className="bg-gray-800/50 p-5 sm:p-6 rounded-xl backdrop-blur-sm"
						>
							<h3 className="text-lg sm:text-xl font-semibold mb-4">Answer Hours</h3>
							<div className="space-y-2 text-gray-400 text-sm sm:text-base">
								<p>Monday - Friday: 9:00 AM - 6:00 PM (EET)</p>
								<p>Saturday: 10:00 AM - 2:00 PM (EET)</p>
								<p>Sunday: Closed</p>
							</div>
						</motion.div>
					</div>
