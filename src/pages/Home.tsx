...
const Home = () => {
	...
	const email = 'erickdevartworks@gmail.com';
	const whatsappNumber = '+37127727393';

	const { data: githubData } = useSWR('https://api.github.com/users/erick-dev-artworks', fetcher);
		...
		<div className="min-h-screen flex items-center justify-center px-4 mt-7 sm:mt-0 md:mt-3 lg:mt-5">
			<div className="text-center relative z-10 max-w-4xl mx-auto">
				...
				<motion.h1
					...
					transition={{ duration: 0.8 }}
				>
					Passion fuels speed and creativity
				</motion.h1>
				...
				>
					<div className="flex justify-center space-x-3 sm:space-x-4">
						<a
							href="/files/cv_pdf/eriks-filipovs-cv.docx"
							target="_blank"
				...
				>
					...
					<motion.a
						href="https://lv.linkedin.com/in/eriks-filipovs-800844288"
						target="_blank"
						rel="noopener noreferrer"
						className="flex flex-col items-center group w-full"
						whileHover={{ y: -2 }}
					>
						...
						<motion.div
							...
							transition={{ delay: 0.8 }}
						>
							<span className="text-base sm:text-lg font-semibold">600+</span>
